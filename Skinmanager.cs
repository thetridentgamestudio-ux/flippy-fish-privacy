...
public static class SkinManager
{
    ...
    public static readonly int[]    SkinCosts   = { 0,         500,        1500,       3000,       8000,          15000          };
    ...
    // 1 coin per 5 pipes — earns from score 5+, keeps skins as genuine achievements
    public static void OnPipePassed(int currentScore)
    {
        if (currentScore % 5 == 0) AddCoins(1);
